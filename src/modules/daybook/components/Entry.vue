<template>
  ...
  >
    ...
    <div class="entry-description">
      ...
      non animi dolorem sapiente enim, minima veritatis voluptate, repellat
      repudiandae quam laboriosam necessitatibus! Quam saepe harum qui
      consequatur architecto quibusdam!
    </div>
  </div>
</template>
